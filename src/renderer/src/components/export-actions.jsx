...
const ExportsContainer = (props) => {
    ...
    const downloadImageExporter = (context, image) => {
        return () => {
            ...
            simulateDownload(
                `${Constants.DownloadPrefix}-${displayName}-${moment().format(
                    'YYYYMMDDHHmmss'
                )}.png`,
            ...
            <div id="exportActions">
                <ExportCard>
                    <div className="control-panel">
                        ...
                        <button
                            className="btn button zoom-out"
                            aria-label="Zoom Out"
                            onClick={() => doZoom(-0.1)}
                        >
                            <ZoomOutIcon />
                        </button>
                        <button className="btn button reset" aria-label="Reset" onClick={reset}>
                            <SyncIcon />
                        </button>
                        <button
                            className="btn button up"
                            aria-label="Pan Up"
                            onClick={() => doMove(-10, 0)}
                        >
                            <ChevronUpIcon />
                    ...
                    <div className="export-buttons">
                        ...
                        <button
                            ...
                            onClick={(e) => onDownloadPngClick(e)}
                        >
                            <ImageIcon />
                        </button>
                    </div>
